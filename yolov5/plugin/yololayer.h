...
namespace Yolo
{
    ...
    static constexpr int CLASS_NUM = CUSTOM_CLASS_NUM;
    static constexpr int INPUT_H = CUSTOM_INPUT_H;  // yolov5's input height and width must be divisible by 32.
    static constexpr int INPUT_W = CUSTOM_INPUT_W;
